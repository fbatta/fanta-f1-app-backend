...
@Service
class RaceResultsServiceImpl(
    private val openF1Client: OpenF1Client,
    private val driverService: DriverService
) : RaceResultsService {
    override suspend fun getResultsForRace(raceWeekend: RaceWeekend, isSprintRace: Boolean): Flow<DriverRaceResult> {
    ...
    companion object {
        private val LOGGER = LoggerFactory.getLogger(RaceResultsServiceImpl::class.java)
    }
}