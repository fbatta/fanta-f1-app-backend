...
@Service
class PracticeResultsServiceImpl(
    private val openF1Client: OpenF1Client,
    private val driverService: DriverService
) : PracticeResultsService {
    override suspend fun getDriversResultsForCombinedPractice(raceWeekend: RaceWeekend): Flow<DriverPracticeResult> {
    ...
    companion object {
        private val LOGGER = LoggerFactory.getLogger(PracticeResultsServiceImpl::class.java)
    }
}